...
public class Login_16_RegisterAndLogin_DataJavaClass extends AbstractTest {
	...
	public void TC_01_RegisterToSystem() {
		...
		registerPage.inputToNopCommerceTextboxByID(driver, "FirstName", com.nopcommerce.data.CustomerData.NewCustomer.FIRSTNAME);
		registerPage.inputToNopCommerceTextboxByID(driver, "LastName", com.nopcommerce.data.CustomerData.NewCustomer.LASTNAME);
		...
		registerPage.inputToNopCommerceTextboxByID(driver, "Email", com.nopcommerce.data.CustomerData.NewCustomer.EMAIL);
		registerPage.inputToNopCommerceTextboxByID(driver, "Company", com.nopcommerce.data.CustomerData.NewCustomer.COMPANYNAME);
		registerPage.inputToNopCommerceTextboxByID(driver, "Password", com.nopcommerce.data.CustomerData.NewCustomer.PASSWORD);
		registerPage.inputToNopCommerceTextboxByID(driver, "ConfirmPassword", com.nopcommerce.data.CustomerData.NewCustomer.PASSWORD);
		log.info("Password is------------------------------ " +com.nopcommerce.data.CustomerData.NewCustomer.PASSWORD);
	...
	public void TC_02_LoginToSystem() {
		...
		loginPage.inputToNopCommerceTextboxByID(driver, "Email", com.nopcommerce.data.CustomerData.NewCustomer.EMAIL);
		loginPage.inputToNopCommerceTextboxByID(driver, "Password", com.nopcommerce.data.CustomerData.NewCustomer.PASSWORD);
